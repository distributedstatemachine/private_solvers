...
pub mod intentbook_events {
    ...
    pub static INTENTBOOKEVENTS_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct IntentbookEvents<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for IntentbookEvents<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for IntentbookEvents<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for IntentbookEvents<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for IntentbookEvents<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IntentbookEvents))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> IntentbookEvents<M> {
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            IntentbookEventsEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
    for IntentbookEvents<M> {
    ...
    impl ::ethers::contract::EthLogDecode for IntentbookEventsEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = IntentCreatedFilter::decode_log(log) {
                return Ok(IntentbookEventsEvents::IntentCreatedFilter(decoded));
            }
    ...
    impl ::core::convert::From<IntentCreatedFilter> for IntentbookEventsEvents {

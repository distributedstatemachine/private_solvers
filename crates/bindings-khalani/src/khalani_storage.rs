...
pub mod khalani_storage {
    ...
    pub static KHALANISTORAGE_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    #[rustfmt::skip]
    ...
    pub struct KhalaniStorage<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for KhalaniStorage<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for KhalaniStorage<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for KhalaniStorage<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for KhalaniStorage<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(KhalaniStorage))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> KhalaniStorage<M> {
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                KHALANISTORAGE_ABI.clone(),
                KHALANISTORAGE_BYTECODE.clone().into(),
                client,
            );

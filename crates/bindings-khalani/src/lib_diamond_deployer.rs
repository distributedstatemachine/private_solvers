...
pub mod lib_diamond_deployer {
    ...
    pub static LIBDIAMONDDEPLOYER_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    pub struct LibDiamondDeployer<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for LibDiamondDeployer<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for LibDiamondDeployer<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for LibDiamondDeployer<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for LibDiamondDeployer<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(LibDiamondDeployer))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> LibDiamondDeployer<M> {
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                LIBDIAMONDDEPLOYER_ABI.clone(),
                LIBDIAMONDDEPLOYER_BYTECODE.clone().into(),
                client,
            );

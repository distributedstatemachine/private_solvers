...
pub mod erc4626_prop {
    ...
    impl ::ethers::core::abi::AbiDecode for ERC4626PropCalls {
        fn decode(
            ...
            if let Ok(decoded) = <PropRTDepositRedeemCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PropRTDepositRedeem(decoded));
            }
            if let Ok(decoded) = <PropRTDepositWithdrawCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PropRTDepositWithdraw(decoded));
            }
            if let Ok(decoded) = <PropRTMintRedeemCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PropRTMintRedeem(decoded));
            }
            if let Ok(decoded) = <PropRTMintWithdrawCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PropRTMintWithdraw(decoded));
            }
            if let Ok(decoded) = <PropRTRedeemDepositCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PropRTRedeemDeposit(decoded));
            }
            if let Ok(decoded) = <PropRTRedeemMintCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PropRTRedeemMint(decoded));
            }
            if let Ok(decoded) = <PropRTWithdrawDepositCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PropRTWithdrawDeposit(decoded));
            }
            if let Ok(decoded) = <PropRTWithdrawMintCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PropRTWithdrawMint(decoded));
            }
            if let Ok(decoded) = <PropAssetCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PropAsset(decoded));
            }
            if let Ok(decoded) = <PropConvertToAssetsCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PropConvertToAssets(decoded));
            }
            if let Ok(decoded) = <PropConvertToSharesCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PropConvertToShares(decoded));
            }
            if let Ok(decoded) = <PropDepositCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PropDeposit(decoded));
            }
            if let Ok(decoded) = <PropMaxDepositCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PropMaxDeposit(decoded));
            }
            if let Ok(decoded) = <PropMaxMintCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PropMaxMint(decoded));
            }
            if let Ok(decoded) = <PropMaxRedeemCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PropMaxRedeem(decoded));
            }
            if let Ok(decoded) = <PropMaxWithdrawCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PropMaxWithdraw(decoded));
            }
            if let Ok(decoded) = <PropMintCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PropMint(decoded));
            }
            if let Ok(decoded) = <PropPreviewDepositCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PropPreviewDeposit(decoded));
            }
            if let Ok(decoded) = <PropPreviewMintCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PropPreviewMint(decoded));
            }
            if let Ok(decoded) = <PropPreviewRedeemCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PropPreviewRedeem(decoded));
            }
            if let Ok(decoded) = <PropPreviewWithdrawCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PropPreviewWithdraw(decoded));
            }
            if let Ok(decoded) = <PropRedeemCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PropRedeem(decoded));
            }
            if let Ok(decoded) = <PropTotalAssetsCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PropTotalAssets(decoded));
            }
            if let Ok(decoded) = <PropWithdrawCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {

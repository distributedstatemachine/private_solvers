...
pub mod erc4626 {
    ...
    pub static ERC4626_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    ...
    impl<M> ::core::fmt::Debug for ERC4626<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(ERC4626)).field(&self.address()).finish()
        }
    }
    ...
    impl ::core::convert::From<DomainSeparatorCall> for ERC4626Calls {
    ...
    impl ::core::convert::From<NoncesCall> for ERC4626Calls {
        fn from(value: NoncesCall) -> Self {
            Self::Nonces(value)
        }
    }
    impl ::core::convert::From<PermitCall> for ERC4626Calls {

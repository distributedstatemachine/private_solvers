...
pub mod mock_permit_2 {
    ...
    impl<M: ::ethers::providers::Middleware> MockPermit2<M> {
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                MOCKPERMIT2_ABI.clone(),
                MOCKPERMIT2_BYTECODE.clone().into(),
                client,
            );
    ...
    impl ::ethers::core::abi::AbiDecode for MockPermit2Errors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for MockPermit2Errors {
    ...
    impl ::ethers::contract::ContractRevert for MockPermit2Errors {
    ...
    impl ::core::fmt::Display for MockPermit2Errors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<::std::string::String> for MockPermit2Errors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<InvalidNonce> for MockPermit2Errors {
        fn from(value: InvalidNonce) -> Self {
            Self::InvalidNonce(value)
        }
    }
    impl ::core::convert::From<InvalidSigner> for MockPermit2Errors {
    ...
    pub enum MockPermit2Calls {
        DomainSeparator(DomainSeparatorCall),
        PermitTransferFrom(PermitTransferFromCall),
    }
    impl ::ethers::core::abi::AbiDecode for MockPermit2Calls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
    ...
    impl ::ethers::core::abi::AbiEncode for MockPermit2Calls {
    ...
    impl ::core::fmt::Display for MockPermit2Calls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<DomainSeparatorCall> for MockPermit2Calls {
        fn from(value: DomainSeparatorCall) -> Self {
            Self::DomainSeparator(value)
        }
    }
    impl ::core::convert::From<PermitTransferFromCall> for MockPermit2Calls {

...
pub mod event_prover {
    ...
    impl<M: ::ethers::providers::Middleware> EventProver<M> {
        ...
        ///Calls the contract's `prove` (0x3abe0793) function
        pub fn prove(
            &self,
            intent: SwapIntent,
        ) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([58, 190, 7, 147], (intent,))
    ...
    ///Container type for all input parameters for the `prove` function with signature `prove((address,uint256,uint32,uint32,address,address,uint256,uint256))` and selector `0x3abe0793`
    #[derive(
        Clone,
    ...
    #[ethcall(
        name = "prove",
        abi = "prove((address,uint256,uint32,uint32,address,address,uint256,uint256))"
    )]

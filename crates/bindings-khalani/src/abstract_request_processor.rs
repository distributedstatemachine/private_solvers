pub use abstract_request_processor::*;
...
pub mod abstract_request_processor {
    ...
    pub static ABSTRACTREQUESTPROCESSOR_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct AbstractRequestProcessor<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for AbstractRequestProcessor<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for AbstractRequestProcessor<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for AbstractRequestProcessor<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for AbstractRequestProcessor<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(AbstractRequestProcessor))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> AbstractRequestProcessor<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers::contract::Contract::new(
                    address.into(),
                    ABSTRACTREQUESTPROCESSOR_ABI.clone(),
                    client,
                ),
            )
        }
    ...
    for AbstractRequestProcessor<M> {

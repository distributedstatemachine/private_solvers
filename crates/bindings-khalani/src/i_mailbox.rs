...
pub mod i_mailbox {
    ...
    impl ::ethers::core::abi::AbiDecode for IMailboxCalls {
        fn decode(
            ...
            if let Ok(decoded) = <DeliveredCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <LatestCheckpointCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <RecipientIsmCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {

...
pub mod swap_intent_filler {
    ...
    impl<M: ::ethers::providers::Middleware> SwapIntentFiller<M> {
        ...
        ///Calls the contract's `fillSwapIntent` (0xa711ff41) function
        pub fn fill_swap_intent(
            ...
            self.0
                .method_hash([167, 17, 255, 65], (intent, filler, fill_amount))
    ...
    ///Container type for all input parameters for the `fillSwapIntent` function with signature `fillSwapIntent((address,bytes,uint32,uint32,address,address,uint256,bytes,uint256,uint256),address,uint256)` and selector `0xa711ff41`
    #[derive(
        Clone,
    ...
    #[ethcall(
        name = "fillSwapIntent",
        abi = "fillSwapIntent((address,bytes,uint32,uint32,address,address,uint256,bytes,uint256,uint256),address,uint256)"
    )]
    ...
    impl ::ethers::core::abi::AbiDecode for SwapIntentFillerCalls {
        fn decode(
            ...
            if let Ok(decoded) = <FillSwapIntentCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {

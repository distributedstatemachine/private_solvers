...
pub mod lib_scaling {
    ...
    pub static LIBSCALING_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    #[rustfmt::skip]
    ...
    pub struct LibScaling<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for LibScaling<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for LibScaling<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for LibScaling<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for LibScaling<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(LibScaling)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> LibScaling<M> {
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                LIBSCALING_ABI.clone(),
                LIBSCALING_BYTECODE.clone().into(),
                client,
            );

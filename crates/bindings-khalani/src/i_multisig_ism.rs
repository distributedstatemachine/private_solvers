...
pub mod i_multisig_ism {
    ...
    pub static IMULTISIGISM_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    pub struct IMultisigIsm<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for IMultisigIsm<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for IMultisigIsm<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for IMultisigIsm<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for IMultisigIsm<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IMultisigIsm))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> IMultisigIsm<M> {
        ...
        > {
            self.0
                .method_hash([46, 14, 210, 52], message)
                .expect("method not found (this should never happen)")
        }
    ...
    pub struct ValidatorsAndThresholdCall {
    ...
    pub enum IMultisigIsmCalls {
        ModuleType(ModuleTypeCall),
        ValidatorsAndThreshold(ValidatorsAndThresholdCall),
        Verify(VerifyCall),
    }
    impl ::ethers::core::abi::AbiDecode for IMultisigIsmCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
            if let Ok(decoded) = <ModuleTypeCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::ModuleType(decoded));
            }
            if let Ok(decoded) = <ValidatorsAndThresholdCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
    ...
    impl ::ethers::core::abi::AbiEncode for IMultisigIsmCalls {
    ...
    impl ::core::fmt::Display for IMultisigIsmCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<ModuleTypeCall> for IMultisigIsmCalls {
        fn from(value: ModuleTypeCall) -> Self {
            Self::ModuleType(value)
        }
    }
    impl ::core::convert::From<ValidatorsAndThresholdCall> for IMultisigIsmCalls {
        fn from(value: ValidatorsAndThresholdCall) -> Self {
            Self::ValidatorsAndThreshold(value)
        }
    }
    impl ::core::convert::From<VerifyCall> for IMultisigIsmCalls {

...
pub mod mock_mailbox {
    ...
    impl ::ethers::core::abi::AbiDecode for MockMailboxCalls {
        fn decode(
            ...
            if let Ok(decoded) = <AddInboundMessageCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::AddInboundMessage(decoded));
            }
            if let Ok(decoded) = <AddRemoteMailboxCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::AddRemoteMailbox(decoded));
            }
            if let Ok(decoded) = <DefaultIsmCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <InboundMessagesCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::InboundMessages(decoded));
            }
            if let Ok(decoded) = <InboundProcessedNonceCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::InboundProcessedNonce(decoded));
            }
            if let Ok(decoded) = <InboundUnprocessedNonceCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <OutboundNonceCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::OutboundNonce(decoded));
            }
            if let Ok(decoded) = <ProcessNextInboundMessageCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::ProcessNextInboundMessage(decoded));
            }
            if let Ok(decoded) = <RemoteMailboxesCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::RemoteMailboxes(decoded));
            }
            if let Ok(decoded) = <SetDefaultIsmCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {

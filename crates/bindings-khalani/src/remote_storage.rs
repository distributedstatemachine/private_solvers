...
pub mod remote_storage {
    ...
    pub static REMOTESTORAGE_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    #[rustfmt::skip]
    ...
    pub struct RemoteStorage<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for RemoteStorage<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for RemoteStorage<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for RemoteStorage<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for RemoteStorage<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(RemoteStorage))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> RemoteStorage<M> {
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                REMOTESTORAGE_ABI.clone(),
                REMOTESTORAGE_BYTECODE.clone().into(),
                client,
            );

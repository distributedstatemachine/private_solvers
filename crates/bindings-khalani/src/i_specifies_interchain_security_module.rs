pub use i_specifies_interchain_security_module::*;
...
pub mod i_specifies_interchain_security_module {
    ...
    pub static ISPECIFIESINTERCHAINSECURITYMODULE_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct ISpecifiesInterchainSecurityModule<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for ISpecifiesInterchainSecurityModule<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for ISpecifiesInterchainSecurityModule<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for ISpecifiesInterchainSecurityModule<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for ISpecifiesInterchainSecurityModule<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(ISpecifiesInterchainSecurityModule))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> ISpecifiesInterchainSecurityModule<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers::contract::Contract::new(
                    address.into(),
                    ISPECIFIESINTERCHAINSECURITYMODULE_ABI.clone(),
                    client,
                ),
            )
        }
    ...
    for ISpecifiesInterchainSecurityModule<M> {
